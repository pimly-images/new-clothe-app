...
function App() {
  ...
  return (
    <div style={{ 
      ...
      <h1 style={{ fontSize: '1.5rem', marginBottom: '10px' }}>今の服装アドバイザー</h1>
      <p style={{ marginBottom: '20px', opacity: 0.8 }}>{locationName}の「今」</p>
      
      <button onClick={handleGetCurrentLocation} style={{ backgroundColor: '#007bff', color: 'white', border: 'none', padding: '10px 20px', borderRadius: '25px', cursor: 'pointer', fontWeight: 'bold', marginBottom: '30px' }}>
        📍 現在地でチェック
      </button>
      ...
      {weather && (
        <>
          <div style={{ 
            margin: '0 auto 40px', maxWidth: '450px', padding: '30px', borderRadius: '30px', 
            ...
            <p style={{ fontSize: '1.1rem', marginBottom: '5px' }}>{weather.weather[0].description}</p>
            <div style={{ fontSize: '5rem', fontWeight: 'bold', color: '#007bff' }}>{currentTemp}℃</div>
